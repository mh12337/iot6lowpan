...
The next step is to create a configuration file for tayga, a very simple one was created, that you can see [here]([input the link!](https://github.com/mh12337/iot6lowpan/blob/main/tayga/tayga.conf)) and placed in /etc/ directory
