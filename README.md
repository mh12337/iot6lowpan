...
## Hardware setup
SD is flashed with a rasbian lite 32 bit image. <br>
There was a mismatch between the standard device tree for the at86rf233 device and the device driver for at86rf230. The sleep pin was set as active low in the device tree, and the SLP_TR is active high [[1]](https://ww1.microchip.com/downloads/en/devicedoc/doc5131.pdf). The driver sets the sleep pin to low during initialization [[2]](https://github.com/torvalds/linux/blob/b4e07588e743c989499ca24d49e752c074924a9a/drivers/net/ieee802154/at86rf230.c#L1543) - this logical low was being interpreted as a physical high on the pin causing a probing error:
